 ...
 */
public class NoteEnityControlor {
    /**
     * Helper
     */
    ...
    private static NoteEnityControlor mDbController;

    /**
     * 获取单例
     */
    public static NoteEnityControlor getInstance(Context context){
        if(mDbController == null){
            synchronized (NoteEnityControlor.class){
                if(mDbController == null){
                    mDbController = new NoteEnityControlor(context);
                }
            }
        }
     ...
     * @param context
     */
    public NoteEnityControlor(Context context) {
    ...
    public List<NoteEnity> searchAll(){
        List<NoteEnity>enitys=noteDao.queryBuilder().list();
        return enitys;
    }
    /**
     * 删除数据
